...
__all__ = [
    'DISPID_SpeechRecoContext', 'SECFIgnoreWidth',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRGetRecognizers',
    'DISPID_SRGCmdSetRuleState', 'SPEI_PHRASE_START',
    'SVSFNLPSpeakPunc', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SVSRunningState', '_RemotableHandle',
    'SAFT8kHz16BitStereo', 'ISpPhoneticAlphabetSelection',
    'DISPIDSPTSI_ActiveLength', 'SPEI_RECO_STATE_CHANGE',
    'SpeechDiscardType', 'SRAImport', 'SpLexicon',
    'eLEXTYPE_PRIVATE2', 'SRTSMLTimeout', 'SpeechTokenShellFolder',
    'ISpeechGrammarRuleState', 'DISPID_SpeechObjectToken',
    'DISPID_SPIGetDisplayAttributes', 'SPDKL_LocalMachine',
    'SPRECORESULTTIMES', 'ISpeechPhraseProperty', 'DISPID_SGRClear',
    'ISpeechRecoResultTimes', 'eLEXTYPE_VENDORLEXICON',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRCEHypothesis',
    'ISequentialStream', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SRADynamic',
    'SGRSTTWildcard', 'DISPID_SFSOpen', 'DISPID_SVEBookmark',
    'SPPHRASEELEMENT', 'SPEI_TTS_AUDIO_LEVEL', 'SPEI_REQUEST_UI',
    'DISPID_SRCCreateGrammar', 'SpeechVoiceSkipTypeSentence',
    'SAFT24kHz16BitStereo', 'SVP_20', 'SPPS_Noun',
    'SpeechCategoryVoices', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRAddState', 'SPWT_DISPLAY', 'DISPID_SVVoice',
    'SPFM_CREATE_ALWAYS', 'SBONone', 'SVP_21',
    'DISPID_SRRSetTextFeedback', 'SP_VISEME_18',
    ...
    'DISPID_SBSRead', 'SVEPrivate', 'DISPID_SRGCommit',
    'DISPID_SRGetPropertyString', 'SPEVENTENUM', 'SSTTWildcard',
    'DISPID_SRCRetainedAudioFormat', 'SpTextSelectionInformation',
    'SAFT16kHz8BitStereo', 'eLEXTYPE_PRIVATE12',
    'SpNullPhoneConverter', 'ISpeechLexiconWord',
    'DISPID_SRGIsPronounceable', 'SpeechGrammarTagUnlimitedDictation',
    'SPSHORTCUTPAIRLIST', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRCEInterference', 'SRSActive', 'SpeechTokenKeyFiles',
    'SpeechRetainedAudioOptions', 'ISpEventSink',
    'DISPID_SVEStreamEnd', 'SAFT12kHz16BitMono',
    'DISPID_SRRecognizer', 'SGSExclusive', 'STCInprocHandler',
    'DISPID_SRSClsidEngine', 'SAFT44kHz16BitStereo', 'SPEI_RESERVED6',
    'SPPS_Function', 'DISPID_SOTDisplayUI', 'SPGRAMMARWORDTYPE',
    'SPLO_STATIC', 'ISpRecoGrammar', 'SVP_4',
    'DISPID_SREmulateRecognition', 'DISPID_SPEEngineConfidence',
    'DISPID_SpeechGrammarRuleState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'eLEXTYPE_USER',
    'SPCONTEXTSTATE', 'SpeechAudioVolume', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SVEWord', 'SPADAPTATIONRELEVANCE', 'DISPID_SLPSymbolic',
    'DISPID_SOTCGetDataKey', 'DISPID_SRRPhraseInfo',
    'SDA_No_Trailing_Space', 'DISPID_SRRSaveToMemory',
    'ISpeechPhraseInfo', 'DISPID_SPEs_NewEnum', 'SPBOOKMARKOPTIONS',
    'SPXMLRESULTOPTIONS', 'SpShortcut', 'DISPID_SRCRequestedUIType',
    'DISPID_SRCEBookmark', 'DISPID_SLWsCount',
    'DISPID_SpeechLexiconWord', 'SDKLCurrentUser', 'DISPID_SAStatus',
    'ISpeechTextSelectionInformation', 'ISpeechPhraseAlternates',
    'DISPID_SOTRemove', 'Speech_Max_Pron_Length',
    'DISPID_SOTCDefault', 'DISPID_SRCEStartStream',
    'DISPID_SPPConfidence', 'SVEStartInputStream', 'SVP_2',
    'SPSHT_NotOverriden', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRGCmdLoadFromFile', 'SGRSTTRule', 'SPWF_INPUT',
    'SpeechRecoProfileProperties', 'SPVPRI_OVER', 'SP_VISEME_13',
    'DISPID_SRRDiscardResultInfo', 'SpFileStream',
    'SpStreamFormatConverter', 'SPPHRASEREPLACEMENT',
    'SPFM_OPEN_READWRITE', 'DISPID_SRCEEndStream',
    'DISPID_SGRSAddWordTransition', 'ISpeechPhraseElements',
    'DISPID_SPIGetText', 'SPPS_SuppressWord', 'SpeechTokenKeyUI',
    'DISPID_SFSClose', 'SPEI_START_INPUT_STREAM', 'SASStop', 'SVP_12',
    'SPSNotOverriden', 'STCAll', 'Speech_StreamPos_RealTime',
    'SpAudioFormat', 'SpCompressedLexicon',
    'DISPID_SRCEPropertyNumberChange', 'SPWT_LEXICAL',
    'DISPID_SLWLangId', 'SPWORDPRONOUNCEABLE', 'SSFMCreateForWrite',
    'DISPID_SLWWord', 'DISPID_SLPsItem', 'DISPID_SVAlertBoundary',
    'SPEI_MIN_SR', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SpeechRecoResult2',
    'SP_VISEME_9', 'SpCustomStream', 'SPEI_VISEME',
    'SAFT11kHz8BitMono', 'DISPID_SPRuleChildren',
    'SAFTADPCM_22kHzStereo', 'ISpeechLexiconPronunciations',
    'SpeechRuleState', 'DISPID_SRCEPhraseStart', 'SpeechVoiceEvents',
    'DISPID_SPAsCount', 'eLEXTYPE_PRIVATE18',
    'ISpeechGrammarRuleStateTransitions', 'SWTAdded',
    'DISPID_SVEStreamStart', 'SVPAlert', 'SPVPRI_NORMAL',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SGRsCommitAndSave',
    'DISPID_SLWsItem', 'DISPID_SpeechPhoneConverter',
    'DISPID_SVSyncronousSpeakTimeout', 'SGDisplay', 'ISpRecoContext2',
    'SPFILEMODE', 'SPBO_NONE', 'SpeechInterference', 'SLTApp',
    'DISPID_SRCEFalseRecognition', 'SPEI_INTERFERENCE',
    'SGDSActiveWithAutoPause', 'SPCT_DICTATION', 'SPCATEGORYTYPE',
    'SVP_14', 'SDKLCurrentConfig', 'DISPID_SPIElements',
    'ISpNotifySink', 'SVSFIsXML', 'DISPID_SOTCSetId',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SDKGetBinaryValue',
    'DISPID_SpeechVoiceEvent', 'SpeechGrammarWordType',
    'SPEI_SOUND_END', 'DISPID_SRIsShared', 'SpeechTokenKeyAttributes',
    'SpObjectToken', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCBookmark', 'DISPID_SPRulesItem', 'DISPID_SRCPause',
    'SASPause', 'SPWF_SRENGINE', 'DISPID_SRDisplayUI',
    'SPCT_SUB_COMMAND', 'DISPID_SRCCreateResultFromMemory',
    'SRADefaultToActive', 'ISpeechBaseStream',
    'SAFTCCITT_uLaw_8kHzStereo', 'SGRSTTWord',
    'DISPID_SOTCreateInstance', 'DISPID_SPIGrammarId',
    'DISPID_SRCVoice', 'SPSInterjection', 'ISpRecognizer3',
    'SPEVENTSOURCEINFO', 'SPAS_PAUSE',
    'DISPID_SPANumberOfElementsInResult', 'SAFT8kHz16BitMono',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRGSetWordSequenceData',
    'SPPROPERTYINFO', 'DISPID_SWFEExtraData',
    'DISPID_SRGDictationLoad', 'SPINTERFERENCE',
    'SAFTNoAssignedFormat', 'SAFTADPCM_11kHzMono',
    'DISPID_SpeechCustomStream', 'SVSFUnusedFlags', 'SRSEIsSpeaking',
    'SPFM_NUM_MODES', 'DISPID_SOTId', 'SP_VISEME_15', 'ISpeechAudio',
    'SPPS_RESERVED2', 'SRARoot', '_SPAUDIOSTATE',
    'DISPIDSPTSI_ActiveOffset', 'SPFM_OPEN_READONLY',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechVoiceStatus',
    'SpeechAllElements', 'SPSHORTCUTTYPE',
    'DISPID_SRAudioInputStream', 'SpeechWordType', 'DISPID_SOTCId',
    'eLEXTYPE_RESERVED10', 'DISPID_SVESentenceBoundary',
    'DISPID_SLPType', 'SAFT48kHz16BitMono',
    'DISPID_SpeechMemoryStream', 'DISPID_SVWaitUntilDone',
    'DISPID_SRSetPropertyNumber', 'SPBINARYGRAMMAR',
    'DISPID_SDKGetStringValue', 'SpeechAddRemoveWord',
    'ISpXMLRecoResult', 'DISPID_SpeechPhraseInfo', 'SGSEnabled',
    'SAFT8kHz8BitMono', 'DISPIDSPRG', 'SSSPTRelativeToEnd',
    'eLEXTYPE_PRIVATE19', 'SAFT16kHz16BitMono', 'SRSEDone',
    'DISPID_SPEDisplayText', 'SPRS_ACTIVE', 'ISpeechVoiceStatus',
    'DISPID_SLGenerationId', 'SpeechGrammarTagDictation',
    'SpeechAudioProperties', 'SP_VISEME_6', 'SpeechPartOfSpeech',
    'SRERequestUI', 'SDTAlternates', 'DISPID_SPPParent', 'ISpPhrase',
    'DISPID_SVSpeakStream', 'DISPID_SpeechPhraseAlternate',
    'ISpeechAudioBufferInfo', 'SRTReSent', 'SpeechGrammarTagWildcard',
    'SP_VISEME_16', 'DISPID_SpeechPhraseRule', 'SAFT11kHz16BitStereo',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpeechStreamFileMode',
    'SAFTADPCM_8kHzMono', 'ISpObjectWithToken',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SpeechFileStream',
    'SpMemoryStream', 'DISPID_SLRemovePronunciation', 'ISpRecoResult',
    'DISPID_SGRsAdd', 'ISpeechAudioStatus', '__MIDL_IWinTypes_0009',
    'DISPID_SPERetainedSizeBytes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRRAlternates',
    'DISPID_SRCRecognizer', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpRecoGrammar2', 'SRERecognition', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechPhraseReplacement', 'SpeechCategoryPhoneConverters',
    'SVSFNLPMask', 'SVEBookmark', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCERecognition',
    'SDA_One_Trailing_Space', 'SPAR_Medium', 'DISPID_SVPriority',
    'SECFIgnoreCase', 'DISPID_SGRAddResource', 'SSFMOpenReadWrite',
    'DISPID_SAVolume', 'SPAUDIOBUFFERINFO',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRSNumberOfActiveRules',
    'SpeechDisplayAttributes', 'IEnumSpObjectTokens',
    'SGDSActiveUserDelimited', 'SAFT12kHz16BitStereo',
    'SPEI_ADAPTATION', 'DISPID_SPPFirstElement',
    'DISPID_SOTGetDescription', 'SDTAudio', 'DISPID_SMSAMMHandle',
    'SPEI_UNDEFINED', 'SPGRAMMARSTATE', 'SVPNormal',
    'DISPID_SDKSetBinaryValue', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechPropertyAdaptationOn', 'DISPID_SRProfile',
    'DISPID_SGRSAddRuleTransition', 'SPRST_INACTIVE',
    'SpeechEmulationCompareFlags', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFTADPCM_11kHzStereo', 'SPEI_RESERVED3', 'SREStreamStart',
    'SpeechVoiceCategoryTTSRate', 'SpeechEngineProperties',
    'SpMMAudioOut', 'SPSHT_OTHER', 'SP_VISEME_8',
    'ISpPhoneticAlphabetConverter', 'SPDKL_CurrentConfig',
    'SPINTERFERENCE_LATENCY_WARNING', 'SDTReplacement',
    'DISPID_SBSFormat', 'SpPhoneConverter', 'SRTAutopause',
    'SP_VISEME_10', 'SPPS_RESERVED3', 'SGDSInactive',
    'SREInterference', 'SpeechSpecialTransitionType',
    'DISPID_SPACommit', 'SAFTExtendedAudioFormat',
    'DISPID_SPEDisplayAttributes', 'SPEVENT', 'SVP_7',
    'DISPID_SLWs_NewEnum', 'DISPID_SPRuleName', 'SVP_9',
    'ISpeechResourceLoader', 'DISPID_SRRTLength',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVSLastResult',
    'SPSHT_Unknown', 'DISPID_SPRuleParent', 'eLEXTYPE_PRIVATE4',
    'SPDKL_DefaultLocation', 'DISPID_SLPLangId', 'SVSFParseSsml',
    'DISPID_SVSPhonemeId', 'DISPID_SPPsItem',
    'DISPID_SLPPartOfSpeech', 'SPXRO_SML', 'Speech_Max_Word_Length',
    'eLEXTYPE_APP', 'SDA_Consume_Leading_Spaces',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SREStateChange', 'SPEI_MAX_TTS',
    'ISpStream', 'DISPID_SWFEBlockAlign', 'SPEI_RESERVED5',
    'SPAUDIOOPTIONS', 'ISpeechDataKey', 'SPRST_NUM_STATES',
    'SSFMCreate', 'SPSMF_UPS', 'SDTRule', 'SAFTCCITT_uLaw_8kHzMono',
    'eLEXTYPE_PRIVATE17', 'SGRSTTEpsilon',
    'DISPID_SVSInputWordPosition', 'DISPID_SRSetPropertyString',
    'SP_VISEME_7', 'SRAExport', 'ISpeechGrammarRules',
    'SRERecoOtherContext', 'DISPID_SRRSpeakAudio', 'SPSHORTCUTPAIR',
    'SREStreamEnd', 'SGDSActive', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SLPsCount', 'SPEI_END_SR_STREAM', 'DISPID_SRSAudioStatus',
    'SPSTREAMFORMATTYPE', 'SpeechLexiconType', 'DISPID_SPCIdToPhone',
    'DISPID_SPERetainedStreamOffset', 'SP_VISEME_0',
    'DISPID_SPEAudioSizeBytes', 'SPAR_Unknown',
    'SpeechPropertyResponseSpeed', 'SAFTGSM610_8kHzMono',
    'SPEI_RESERVED2', 'ISpeechPhraseRules', 'SPEI_VOICE_CHANGE',
    'DISPID_SPRText', 'DISPID_SPAStartElementInResult',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechUserTraining', 'SpeechRunState', 'DISPID_SPIAudioSizeTime',
    'SPAUDIOSTATE', 'DISPID_SPPEngineConfidence', 'SVEVoiceChange',
    'SPSNoun', 'SPEI_MAX_SR',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SWFEChannels', 'SPDKL_CurrentUser', 'SPRS_INACTIVE',
    'DISPID_SpeechWaveFormatEx', 'SVP_11',
    'SWPUnknownWordPronounceable', 'ISpVoice', 'SDTProperty',
    'eLEXTYPE_PRIVATE1', 'SPPHRASERULE', 'SPCS_DISABLED',
    'SpInprocRecognizer', 'SpeechTokenIdUserLexicon',
    'SpeechAudioState', 'SPGS_EXCLUSIVE', 'DISPID_SWFEAvgBytesPerSec',
    'SpSharedRecoContext', 'DISPID_SVSLastBookmark',
    'SpeechRecoEvents', 'SITooSlow', 'DISPID_SPRuleId',
    'SPSEMANTICERRORINFO', 'DISPID_SRGRecoContext',
    'SAFT24kHz8BitStereo', 'DISPID_SPRNumberOfElements',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SABufferInfo',
    'SPAUDIOSTATUS', 'SRCS_Enabled', 'SPSLMA', 'SVSFIsFilename',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SGRId', 'SDTLexicalForm',
    'DISPID_SVEAudioLevel', 'SPSERIALIZEDRESULT',
    'DISPID_SVEVoiceChange', 'SAFT22kHz16BitStereo',
    'IInternetSecurityMgrSite', 'SLODynamic',
    'SPEI_RECO_OTHER_CONTEXT', 'UINT_PTR', 'DISPID_SDKCreateKey',
    'SAFTCCITT_uLaw_11kHzMono', 'SGLexical', 'ISpeechPhraseRule',
    'SVF_Stressed', '_ISpeechRecoContextEvents',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRCreateRecoContext',
    ...
    'DISPID_SGRs_NewEnum', 'DISPID_SRRRecoContext', 'SP_VISEME_4',
    'SPXRO_Alternates_SML', 'eLEXTYPE_PRIVATE5', 'SPPS_NotOverriden',
    'SINoise', 'SRTStandard', 'SpeechTokenValueCLSID',
    'DISPID_SRIsUISupported', 'DISPID_SRCERequestUI',
    'DISPID_SGRSTType', 'SPEI_START_SR_STREAM', 'SPBO_TIME_UNITS',
    'SpResourceManager', 'SP_VISEME_17', 'DISPID_SDKEnumValues',
    'DISPID_SRRTimes', 'DISPID_SpeechAudio',
    'DISPID_SRRTOffsetFromStart', 'SPLOADOPTIONS',
    'DISPID_SPIReplacements', 'DISPID_SMSSetData', 'tagSTATSTG',
    'SpeechPropertyLowConfidenceThreshold', 'SpSharedRecognizer',
    'DISPID_SVResume', 'SRSActiveAlways', 'eLEXTYPE_USER_SHORTCUT',
    'eLEXTYPE_RESERVED9', 'ISpeechRecoResult2',
    'ISpeechPhraseElement', 'SPPS_Verb', 'DISPID_SLWType',
    'SAFT22kHz8BitStereo', 'DISPID_SCSBaseStream',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPCPhoneToId',
    'eLEXTYPE_PRIVATE8', 'eLEXTYPE_PRIVATE13',
    'SpeechRecognizerState', 'SVEEndInputStream',
    '_ISpeechVoiceEvents', 'DISPID_SVGetAudioOutputs',
    'SPEI_TTS_PRIVATE', 'SP_VISEME_2', 'STSF_AppData',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechGrammarRules',
    'SPAS_STOP', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    ...
    'SDTDisplayText', 'SPRULESTATE', 'SREHypothesis',
    'SpeechVoiceSpeakFlags', 'SPRST_ACTIVE', 'SPVISEMES',
    'SpeechEngineConfidence', 'SAFTADPCM_44kHzStereo',
    'DISPID_SpeechGrammarRuleStateTransition', 'SRAORetainAudio',
    'SVSFParseAutodetect', 'SVP_18', 'SpPhoneticAlphabetConverter',
    'DISPID_SGRAttributes', 'ISpeechRecoGrammar', 'SVP_6',
    'DISPID_SRCEAudioLevel', 'SPCT_SLEEP', 'ISpRecognizer2',
    'SPDATAKEYLOCATION', 'SGPronounciation',
    'DISPID_SOTCEnumerateTokens', 'ISpPhraseAlt',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPEsItem',
    'DISPID_SGRsCommit', 'DISPID_SpeechMMSysAudio',
    'SpeechRuleAttributes', 'DISPID_SRRTTickCount',
    'DISPID_SGRSAddSpecialTransition', 'SpeechTokenContext',
    'SAFT22kHz16BitMono', 'DISPID_SpeechRecoResult',
    ...
    'SGLexicalNoSpecialChars', 'SSTTTextBuffer', 'SPRULE',
    'DISPID_SRCCmdMaxAlternates', 'SPSVerb', 'DISPID_SVSVisemeId',
    'SPINTERFERENCE_TOOLOUD', 'SRTEmulated',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRAudioInput',
    'SPGS_ENABLED', 'SPCT_SUB_DICTATION', 'DISPID_SPPName',
    'ISpStreamFormat', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVSCurrentStreamNumber', 'SDKLLocalMachine',
    'SAFT44kHz8BitMono', 'DISPID_SpeechPhraseRules', 'SPAR_High',
    'DISPID_SRSCurrentStreamPosition', 'SAFT48kHz16BitStereo',
    'SPPS_Modifier', 'SAFTGSM610_22kHzMono', 'eLEXTYPE_RESERVED8',
    'DISPID_SVSInputWordLength', 'DISPID_SVSInputSentenceLength',
    'eLEXTYPE_PRIVATE11', 'ISpAudio', 'ISpeechLexicon',
    'eLEXTYPE_PRIVATE20', 'SPRST_ACTIVE_ALWAYS', 'SVP_3',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SREAudioLevel',
    'SpVoice', 'STCInprocServer', 'SVESentenceBoundary',
    'SpObjectTokenCategory', 'SP_VISEME_1', 'SPINTERFERENCE_TOOSLOW',
    'SVSFVoiceMask', 'eLEXTYPE_PRIVATE7', 'SGRSTTTextBuffer',
    'ISpSerializeState', 'ISpeechMemoryStream', 'SPGS_DISABLED',
    'eLEXTYPE_PRIVATE10', 'SPSSuppressWord',
    'SpeechCategoryRecoProfiles', 'SPPS_Unknown', 'SPPHRASEPROPERTY',
    'SASClosed', 'DISPID_SPRsItem', 'DISPID_SLAddPronunciation',
    'ISpeechLexiconWords', 'DISPID_SPRules_NewEnum',
    'SPEI_RECOGNITION', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SDKGetlongValue',
    'DISPID_SGRSTPropertyValue', 'DISPID_SLGetGenerationChange',
    'DISPID_SVGetProfiles', 'SSFMOpenForRead', 'SVP_17',
    'SVSFDefault', 'SPWORDPRONUNCIATIONLIST',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SGRSTPropertyName',
    'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPPValue',
    'DISPID_SDKDeleteValue', 'SVP_8', 'SGSDisabled',
    'SDTPronunciation', 'SBOPause', 'DISPID_SPAsItem',
    'ISpeechXMLRecoResult', 'DISPID_SpeechDataKey', 'SPSFunction',
    'DISPID_SVEEnginePrivate', 'DISPID_SVVolume', 'DISPID_SPIRule',
    'DISPID_SAFSetWaveFormatEx', 'SpMMAudioEnum', 'SPPS_RESERVED1',
    'SLOStatic', 'ISpLexicon', 'SPAO_NONE', 'SDKLDefaultLocation',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SRGReset',
    'DISPID_SPPs_NewEnum', 'SPWAVEFORMATTYPE',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SVPause',
    'SPSHT_EMAIL', 'DISPID_SDKOpenKey', 'SPVOICESTATUS',
    'SP_VISEME_14', 'SVSFIsNotXML', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRCEAdaptation', 'DISPID_SLPPhoneIds', 'SPEI_SOUND_START',
    'ISpeechRecoResultDispatch', 'SLTUser', 'DISPID_SOTDataKey',
    'ISpeechPhraseInfoBuilder', 'SPBO_PAUSE', 'SPAR_Low',
    'DISPID_SASCurrentSeekPosition', 'SECFIgnoreKanaType',
    'SPVPRI_ALERT', 'DISPID_SGRSTRule', 'DISPID_SDKEnumKeys',
    'ISpMMSysAudio', 'ISpeechPhraseAlternate', 'DISPID_SLGetWords',
    ...
    'DISPID_SASFreeBufferSpace', 'DISPID_SPRuleFirstElement',
    'SPPHRASE', 'SpeechRegistryUserRoot', 'DISPID_SRGDictationUnload',
    'SVP_16', 'SpeechBookmarkOptions', 'DISPID_SDKDeleteKey',
    'SAFT24kHz8BitMono', 'SREPhraseStart',
    'ISpeechLexiconPronunciation', 'DISPID_SLWPronunciations',
    'SPEI_PROPERTY_NUM_CHANGE', 'SECNormalConfidence',
    'DISPID_SPARecoResult', 'SPSEMANTICFORMAT', 'SAFT48kHz8BitStereo',
    'DISPID_SVEPhoneme', 'SAFTADPCM_22kHzMono', 'SVP_5', 'SVP_0',
    'DISPID_SpeechVoice', 'ISpShortcut',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SDKSetLongValue',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SVAudioOutput',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPISaveToMemory',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPIRetainedSizeBytes',
    'ISpeechGrammarRuleStateTransition', 'eLEXTYPE_RESERVED7',
    'DISPID_SRGetFormat', 'SPAS_CLOSED', 'SpeechAudioFormatType',
    'ISpeechRecoResult', 'SAFTCCITT_ALaw_44kHzStereo', 'SASRun',
    'SPRECOSTATE', 'DISPID_SpeechLexiconWords', 'SITooLoud',
    'DISPID_SRCEventInterests', 'SPSUnknown',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SpeechPhraseReplacements', 'SRSInactiveWithPurge',
    'SPLO_DYNAMIC', 'SVSFlagsAsync', 'DISPID_SRGDictationSetState',
    'SpInProcRecoContext', 'SPPS_RESERVED4', 'ISpeechVoice',
    'SPCS_ENABLED', 'SPLEXICONTYPE', 'DISPID_SVIsUISupported',
    'SVPOver', 'DISPID_SAFType', 'DISPID_SPIAudioStreamPosition',
    'SVP_1', 'DISPID_SDKSetStringValue', 'SpPhraseInfoBuilder',
    'SAFTText', 'SVSFParseSapi', 'SRATopLevel', 'ISpEventSource',
    'DISPID_SPELexicalForm', 'DISPID_SVAudioOutputStream',
    'DISPID_SPPNumberOfElements', 'SAFT48kHz8BitMono',
    'DISPID_SGRSTsCount', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPEI_END_INPUT_STREAM', 'SVSFParseMask', 'DISPID_SPAPhraseInfo',
    'STCRemoteServer', 'SPEI_MIN_TTS', 'DISPID_SPPChildren',
    'DISPID_SOTsCount', 'ISpeechFileStream', 'DISPID_SPAs_NewEnum',
    'DISPID_SPEPronunciation', 'DISPID_SpeechAudioStatus', 'SINone',
    'SAFT16kHz16BitStereo', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRGRules', 'SP_VISEME_19', 'DISPID_SRRAudio',
    'ISpeechGrammarRule', 'ISpObjectTokenCategory',
    'SAFT16kHz8BitMono', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechAudioFormat', 'eLEXTYPE_PRIVATE16', 'SPBO_AHEAD',
    'DISPID_SRCESoundEnd', 'SREPropertyNumChange',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPINTERFERENCE_NONE', 'SpeechRecognitionType',
    'SpeechDataKeyLocation', 'SpUnCompressedLexicon',
    'SPEI_HYPOTHESIS', 'SpeechVisemeType',
    'DISPID_SpeechAudioBufferInfo', 'SRESoundEnd',
    'DISPID_SGRSTsItem', 'SpeechLoadOption', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechLexiconProns', 'SPTEXTSELECTIONINFO',
    'SPSERIALIZEDPHRASE', 'SAFT32kHz16BitStereo',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SpeechRecognizerStatus',
    'SPPS_Interjection', 'SpNotifyTranslator', 'DISPID_SAEventHandle',
    ...
    'SVF_None', 'DISPID_SRGCmdLoadFromMemory', 'SpeechVoicePriority',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SOTRemoveStorageFileName',
    'SSTTDictation', 'DISPID_SRRGetXMLResult', 'SPFM_CREATE',
    'SP_VISEME_21', 'SECFNoSpecialChars', 'SAFTCCITT_uLaw_22kHzMono',
    'STSF_LocalAppData', 'ISpDataKey', 'SECFEmulateResult',
    'DISPID_SPIEnginePrivateData', 'ISpGrammarBuilder',
    'DISPID_SVSpeak', 'DISPID_SPRuleConfidence', 'SpWaveFormatEx',
    'DISPID_SPERequiredConfidence', 'ISpResourceManager',
    'SPEI_SR_PRIVATE', 'DISPID_SPIStartTime', 'DISPID_SRGState',
    'DISPID_SGRSTPropertyId', 'SP_VISEME_20', 'DISPID_SPRsCount',
    'SREPrivate', 'DISPID_SOTGetAttribute', 'SAFTNonStandardFormat',
    'DISPID_SRRAudioFormat', 'DISPID_SGRSTWeight',
    'SpeechVisemeFeature', 'DISPID_SPPId', 'DISPID_SVSkip',
    'SRAInterpreter', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechPhraseAlternates', 'SVEAudioLevel',
    'DISPID_SOTsItem', 'ISpNotifyTranslator', 'DISPID_SGRSTText',
    'SRTExtendableParse', 'DISPID_SOTCategory',
    'DISPID_SpeechBaseStream', 'DISPID_SBSSeek', 'DISPID_SGRsCount',
    'SRESoundStart', 'SPWORDLIST', 'SAFT44kHz16BitMono',
    'SAFT32kHz16BitMono', 'SPAS_RUN', 'SPEI_RESERVED1',
    'DISPID_SPRuleEngineConfidence', 'ISpeechRecognizerStatus',
    'SpeechPropertyResourceUsage', 'SAFTDefault', 'SECFDefault',
    'SAFT22kHz8BitMono', 'SpeechGrammarRuleStateTransitionType',
    'SpeechFormatType', 'DISPID_SVEViseme',
    'DISPID_SPEActualConfidence', 'DISPID_SAFGuid',
    'SpeechRecoContextState', 'SAFT12kHz8BitMono', 'SFTSREngine',
    'SFTInput', 'IInternetSecurityManager', 'DISPID_SABIEventBias',
    'SDTAll', 'SP_VISEME_12', 'DISPID_SPEsCount', 'ISpPhoneConverter',
    'SPPARTOFSPEECH', 'SPINTERFERENCE_TOOQUIET', 'DISPID_SVRate',
    'DISPID_SRCERecognitionForOtherContext', 'DISPIDSPTSI',
    'DISPID_SOTIsUISupported', 'tagSPPROPERTYINFO', 'SPWORDTYPE',
    'DISPID_SRRTStreamTime', 'SpMMAudioIn', 'SpStream',
    'ISpeechPhraseProperties', 'DISPID_SRSCurrentStreamNumber',
    'SAFTGSM610_44kHzMono', 'SVP_13', 'SECHighConfidence',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTSetId',
    'ISpeechCustomStream', 'eLEXTYPE_PRIVATE14',
    'DISPID_SOTGetStorageFileName', 'SVEViseme',
    'DISPID_SMSADeviceId', 'SDA_Two_Trailing_Spaces',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPPsCount',
    'ISpObjectToken', 'DISPID_SLPs_NewEnum', 'STSF_FlagCreate',
    'SpeechWordPronounceable', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechXMLRecoResult', 'SVP_19', 'ISpeechWaveFormatEx',
    'DISPID_SASCurrentDevicePosition', 'SPEI_SR_BOOKMARK',
    'SREPropertyStringChange', 'SGRSTTDictation', 'SITooQuiet',
    'SpeechMicTraining', 'SpeechRegistryLocalMachineRoot',
    'SAFT8kHz8BitStereo', 'DISPID_SpeechPhraseElement',
    'SREAllEvents', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPIProperties', 'SVP_15', 'SPWORD',
    'DISPID_SpeechRecognizer', 'SPSModifier', 'eLEXTYPE_PRIVATE3',
    'eLEXTYPE_PRIVATE6', 'DISPID_SMSALineId', 'ISpRecoContext',
    'DISPID_SRCState', 'SSSPTRelativeToStart', 'SRCS_Disabled',
    'DISPID_SLGetPronunciations', 'LONG_PTR', 'DISPID_SVGetVoices',
    'Speech_Default_Weight', 'DISPID_SRState', 'DISPID_SPILanguageId',
    'DISPID_SpeechLexicon', 'SREBookmark',
    'SAFTTrueSpeech_8kHz1BitMono', 'SVSFPersistXML',
    'DISPID_SASetState', 'SpeechCategoryRecognizers',
    'SpeechPropertyHighConfidenceThreshold', 'IEnumString',
    'SPRECOGNIZERSTATUS', 'SWPKnownWordPronounceable', 'SPCT_COMMAND',
    ...
    'SVP_10', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SABIMinNotification', 'eWORDTYPE_DELETED',
    'DISPID_SVEventInterests', 'Speech_StreamPos_Asap',
    'SPSMF_SAPI_PROPERTIES', 'ISpRecognizer',
    'DISPID_SPIAudioSizeBytes', 'ISpStreamFormatConverter',
    'SAFT32kHz8BitStereo', 'DISPID_SGRsItem', 'DISPID_SOTs_NewEnum',
    'SpeechCategoryAudioOut', 'SREAdaptation',
    'SpeechDictationTopicSpelling', 'eLEXTYPE_RESERVED6',
    'DISPID_SMSGetData', 'DISPID_SABIBufferSize',
    'DISPID_SWFEFormatTag', 'SPEI_PHONEME',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRStatus', 'SVEWordBoundary', 'SWTDeleted', 'SITooFast',
    'DISPID_SRCResume', 'ISpeechObjectToken', 'ISpeechRecoContext',
    'SPWORDPRONUNCIATION', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SGRSRule',
    'ISpeechPhraseReplacements', 'WAVEFORMATEX', 'SAFT32kHz8BitMono',
    'DISPID_SVDisplayUI', 'DISPID_SGRName', 'STCLocalServer',
    'SREFalseRecognition', 'ISpNotifySource', 'ISpRecoCategory',
    'SPPS_LMA', 'DISPID_SASNonBlockingIO',
    'DISPID_SAFGetWaveFormatEx', 'STSF_CommonAppData',
    'SPWT_PRONUNCIATION', 'SSSPTRelativeToCurrentPosition',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SP_VISEME_11',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSTransitions',
    'SP_VISEME_5', 'SRAONone', 'DISPID_SPIEngineId',
    'SVSFPurgeBeforeSpeak', 'IStream', 'DISPID_SpeechObjectTokens',
    'eLEXTYPE_PRIVATE15', 'SPVPRIORITY', 'DISPID_SPRulesCount',
    'SECLowConfidence', 'eWORDTYPE_ADDED', 'DISPID_SRGId',
    'SAFTADPCM_44kHzMono', 'DISPID_SGRsDynamic', 'SVEPhoneme',
    'ISpeechAudioFormat', 'SAFT44kHz8BitStereo', 'SPPS_Noncontent',
    'ISpeechObjectTokenCategory', 'ISpProperties', 'DISPID_SBSWrite',
    'DISPID_SADefaultFormat', 'DISPID_SGRInitialState',
    'DISPID_SGRsFindRule', 'SpeechAudioFormatGUIDText',
    'DISPID_SPRs_NewEnum', 'DISPID_SRCESoundStart', 'DISPID_SASState',
    'DISPID_SPCLangId'
]

_check_version('1.1.14', 1640556958.193201)
